...
export const metadata: Metadata = {
  title: "StoryWala AI | Transform Prompts into Cinematic Stories",
  description: "Generate breathtaking 4K videos from text snippets using advanced AI. Storytelling redefined.",
};
